...
config.patterns.copy = array.maybeAdd(config.patterns.copy, config.folder.images, config.path.source, isProduction ? config.cache.name : '[name]');
config.patterns.copy = array.maybeAdd(config.patterns.copy, config.folder.fonts, config.path.source, isProduction ? config.cache.name : '[name]');
