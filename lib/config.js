...
config.patterns.copy = array.maybeAdd(config.patterns.copy, config.folder.images, config.path.source);
config.patterns.copy = array.maybeAdd(config.patterns.copy, config.folder.fonts, config.path.source);
config.patterns.regexp = array.toRegexp(config.patterns.copy);
